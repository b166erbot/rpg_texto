...
class Caverna:
    ...
    def __init__(self, nome_caverna: str, personagem, level: int):
        ...
        self._caminhos = gerar_fluxo_caverna()
...
def gerar_fluxo_covil_do_arauto():
    """Função que retorna uma lista com fluxos."""
    passagens = [
        "bifurcação",
        "área aberta",
...
class CovilDoArauto:
    def __init__(self, personagem, level: int):
        ...
        self.personagem = personagem
        self._caminhos = gerar_fluxo_covil_do_arauto()
