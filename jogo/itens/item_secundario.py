...
class ItemDeDefesa:
    ...
    tipo = "Escudo"
    def __init__(
        self, nome: str, vida: int, armadura: int,
        resistencia: int, bloqueio: int, classe: str
    ):
        self.nome = nome
        self.vida = vida
...
class ItemDeDano:
    ...
    tipo = "Arma"
    def __init__(
        self, nome: str, dano: int, critico: int,
        porcentagem_critico: int, classe: str
    ):
        self.nome = nome
        self.dano = dano
        ...
        self.bonus = []
        self.preco = Pratas(
            (dano + critico + (porcentagem_critico // 2)) * 8
        )
        self.conjunto = "item comum"
