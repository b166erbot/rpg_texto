...
class TestAcumulador(TestCase):
    ...
    def test_valor_faltando_retorna_0_caso_depositar_valor_receba_maximo_de_glifos(self):
        valor = self.acumulador.valor_total()
        self.acumulador.depositar_valor(valor)
        self.assertEqual(self.acumulador.valor_faltando(), 0)
    
    def test_valor_faltando_retorna_0_caso_acumular_esteja_no_level_maximo(self):
        self.acumulador = Acumulador(0, [1,2,3,4,5,6], 7)
        self.assertEqual(self.acumulador.valor_faltando(), 0)
    ...
    def test_valor_faltando_retorna_5_caso_acumular_esteja_no_level_6_e_com_1_de_valor(self):
...
class TestMenorNumero(TestCase):
    ...
    def test_menor_numero_retornando_29_caso_numero_seja_maior_que_o_maximo(self):
