...
from jogo.itens.pocoes import (ElixirDeVidaExtraGrande, ElixirDeVidaFraca,
                               ElixirDeVidaGrande, ElixirDeVidaMedia)

with mock.patch('jogo.personagens.classes.tela') as mocked_lib:
    from jogo.personagens.classes import (
        Mago, Arqueiro, Guerreiro, Assassino, Clerigo, Monge
    )
curses.endwin()
...
class TestCriticoArqueiro(TestCase):
    ...
    def test_critico_nao_funcionando_caso_valor_menor_que_80_tres_flechas(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.tres_flechas(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 90)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_tres_flechas_como_bot(self, mocked):
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=100)
    def test_critico_dando_o_dobro_de_dano_flecha_de_fogo_como_bot(self, mocked):
        self.personagem2.flecha_de_fogo(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 70)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_flecha_de_fogo(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.flecha_de_fogo(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 85)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_flecha_de_fogo_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.flecha_de_fogo(self.personagem)
...
class TestCriticoGuerreiro(TestCase):
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_investida(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.investida(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 90)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_investida_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.investida(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 90)
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_esmagar(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.esmagar(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 85)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_esmagar_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.esmagar(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 85)
...
class TestCriticoMago(TestCase):
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_lanca_de_gelo(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.lanca_de_gelo(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 90)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_lanca_de_gelo_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.lanca_de_gelo(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 90)
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_bola_de_fogo(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.bola_de_fogo(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 85)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_bola_de_fogo_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.bola_de_fogo(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 85)
...
class TestCriticoAssassino(TestCase):
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_lancar_faca(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.lancar_faca(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 90)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_lancar_faca_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.lancar_faca(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 90)
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=100)
    def test_critico_dando_o_dobro_de_dano_ataque_furtivo_como_bot(self, mocked):
        self.personagem2.ataque_furtivo(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 70)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_ataque_furtivo(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.ataque_furtivo(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 85)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_ataque_furtivo_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.ataque_furtivo(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 85)
...
class TestCriticoClerigo(TestCase):
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_curar(self, mocked):
        self.personagem.status['vida'] = 0
        self.personagem.porcentagem_critico = 80
        self.personagem.curar(self.personagem2)
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_curar_como_bot(self, mocked):
        self.personagem2.status['vida'] = 0
        self.personagem2.porcentagem_critico = 80
        self.personagem2.curar(self.personagem)
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_luz_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.luz(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 90)
...
class TestCriticoMonge(TestCase):
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=100)
    def test_critico_dando_o_dobro_de_dano_multiplos_socos_como_bot(self, mocked):
        self.personagem2.multiplos_socos(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 80)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_multiplos_socos(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.multiplos_socos(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 90)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_multiplos_socos_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.multiplos_socos(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 90)
    ...
    @mock.patch('jogo.personagens.classes.randint', return_value=100)
    def test_critico_dando_o_dobro_de_dano_combo_de_chutes_como_bot(self, mocked):
        self.personagem2.combo_de_chutes(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 70)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_combo_de_chutes(self, mocked):
        self.personagem.porcentagem_critico = 80
        self.personagem.combo_de_chutes(self.personagem2)
        self.assertEqual(self.personagem2.status['vida'], 85)

    @mock.patch('jogo.personagens.classes.randint', return_value=81)
    def test_critico_nao_funcionando_caso_valor_menor_que_80_combo_de_chutes_como_bot(self, mocked):
        self.personagem2.porcentagem_critico = 80
        self.personagem2.combo_de_chutes(self.personagem)
        self.assertEqual(self.personagem.status['vida'], 85)